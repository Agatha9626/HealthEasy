...
<body style="padding-top: 0px; background-color: #dfe4ea;">
	...
	<div class="main">
		...
		<form class="example" method="POST" action="" style="margin:auto;max-width:700px">
		  <input type="text" placeholder="Search.." autocomplete="off" name="nationalID">
				...
				while($row = mysqli_fetch_array($query_run)){
					...
					<form action="" method="POST">
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" name="full_name" style="text-transform: capitalize;" value="<?php echo $row['full_name'] ?>"/>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">		
								<input type="text" class="form-control" style="text-transform: capitalize;" name="gender" value="<?php echo $row['gender'] ?>"/>
							</div>	
						</div>
...
<?php
	...
	if(isset($_POST['update'])){
		...
		$query = "UPDATE `user` SET full_name='$_POST[full_name]', county='$_POST[county]', DOB='$_POST[DOB]', gender='$_POST[gender]', height='$_POST[height]', weight='$_POST[weight]', email_address='$_POST[email_address]', telephone_number='$_POST[telephone_number]', username='$_POST[username]' WHERE nationalID='$_POST[nationalID]' ";
		$query_run = mysqli_query($connection,$query);
...
if(isset($_POST['delete'])){
		...
		$query = "DELETE FROM `user` WHERE nationalID='$_POST[nationalID]' ";
		$query_run = mysqli_query($connection,$query);
